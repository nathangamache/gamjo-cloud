...
export default function App() {
  ...
  const [themePref, setThemePrefState] = useState(() => localStorage.getItem('gamjo-theme') || 'system');
  ...
  const applyPrefs = (resolvedTheme, rm, a) => {
